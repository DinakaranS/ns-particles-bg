...
var Canvas = function (_React$Component) {
  ...
  function Canvas(props) {
    ...
    _this.resize = function () {
      ...
      var _this$setCanvasSize = _this.setCanvasSize(canvas),
          width = _this$setCanvasSize.width,
          height = _this$setCanvasSize.height;

      _this.props.onResize && _this.props.onResize(width, height);
    };
